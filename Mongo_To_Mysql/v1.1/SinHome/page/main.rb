#<Encoding:UTF-8>
require '/home/kaogaau/Mongo_To_Mysql/SinHome/page/lib/pages.rb'
require '/home/kaogaau/Mongo_To_Mysql/SinHome/page/lib/posts.rb'
require '/home/kaogaau/Mongo_To_Mysql/SinHome/page/lib/users.rb'
require '/home/kaogaau/Mongo_To_Mysql/SinHome/page/lib/likes.rb'
require '/home/kaogaau/Mongo_To_Mysql/SinHome/page/lib/comments.rb'
require 'mongo'
require 'mysql2'
t1 = Time.now
Mongo::Logger.logger.level = ::Logger::FATAL
mongo_client = Mongo::Client.new([ '192.168.26.180:27017' ],:database =>'fb_rawdata_sinhome',:user =>'admin',:password =>'12345')
mysql_client = Mysql2::Client.new(:username => "kaogaau",:password=>'12345',:host => "localhost",:port => 3306,:database=>'fb_page_sinhome')#用mysql2
